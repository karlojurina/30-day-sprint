...
/**
 * The Workshop Cabinet — a grid of artifacts the student collects by
 * charting each region. Locked items appear as faded silhouettes; unlocked
 * ones glow in parchment gold. Pure SVG — swappable for real illustrations
 * later if we commission them.
 */
  ...
  return (
    ...
    >
      ...
      <div className="flex items-baseline justify-between mb-5">
        ...
        >
          {unlockedItems} / {totalItems} collected ·{" "}
